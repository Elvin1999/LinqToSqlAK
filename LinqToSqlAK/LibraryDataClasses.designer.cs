...
namespace LinqToSqlAK
{
    ...
    partial void DeleteTheme(Theme instance);
		...
		public LibraryDataClassesDataContext() : 
				base(global::LinqToSqlAK.Properties.Settings.Default.LibraryConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnTheme2Changing(string value);
    partial void OnTheme2Changed();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Theme2", DbType="NVarChar(30)")]
		public string Theme2
		{
			...
			set
			{
				if ((this._Theme2 != value))
				{
					this.OnTheme2Changing(value);
					this.SendPropertyChanging();
					this._Theme2 = value;
					this.SendPropertyChanged("Theme2");
					this.OnTheme2Changed();
				}
			}
		}
